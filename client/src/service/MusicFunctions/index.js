...
class MusicFunctions {
    ...
    */
    ...
    normalizeInputStringToPCArray( inString ) {
     ...
     */
    normalizePCsToNumberArray( inArray ) {
        var outArray = [];
    ...
    getPCSequenceString( memberArray ) {
        var outString = "";
    ...
    getLilypondPitchString( pitches, accidentalPref ) {
        let valueString = "";
    ...
    getFlavor( noteNums, index, preferredFlavor = "s" ) {
    ...
    getMeiPitchClass( pitchNum, noteId, flavor = "s", color = "#000" ) {
    ...
    getMeiPitch( pitchNum, noteId, flavor = "s", color = "#000" ) {
        // <note xml:id="note-L376F1" dur="4" oct="4" pname="e" accid="n" stem.len="0" />
        var pitch = '';
        var accidental = '';
        var noteColor = color;
